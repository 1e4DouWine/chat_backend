...
func newFriendRequest(db *gorm.DB, opts ...gen.DOOption) friendRequest {
	...
	_friendRequest.ID = field.NewUint(tableName, "id")
	...
	_friendRequest.SenderID = field.NewString(tableName, "sender_id")
	_friendRequest.ReceiverID = field.NewString(tableName, "receiver_id")
...
func (f *friendRequest) updateTableName(table string) *friendRequest {
	...
	f.SenderID = field.NewString(table, "sender_id")
	f.ReceiverID = field.NewString(table, "receiver_id")
